           ...
           port=1589;
			...
			while (!this.stop) {
				...
				// ****** Dans le cas d'un paquet requete *****
                    ...
                    //we skipped the 10 next bytes to reach the QUESTION Part
                    ...
                    //We string we store in the domainName from the request
                    String domainName = "";
                ...
                System.out.println(domainName);
                    ...
                    if (this.RedirectionSeulement){
                        ...
                        if(domainIpList == null){
                            ...
                            UDPAnswerPacketCreator newAnswer = UDPAnswerPacketCreator.getInstance();
                            newAnswer.CreateAnswerPacket(paquetRecu.getData(),domainIpList);
